...
const InfoClientModal = ({ visible, onClose, onSave, name, phoneNumber,email,password,id,AdminId,joinDate}) => {
 ...
 const navigation = useNavigation();
  ...
  const AddVisit = async () => {
      navigation.navigate('SearchClientVisit', {
      AdminId: AdminId,
      id: id,
      name:name
    });
  ...
  const contact = async () => {
 navigation.navigate('VetMessageScreen', { currentClientID: id })
};
